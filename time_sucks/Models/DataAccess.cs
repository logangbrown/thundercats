/*
 *  THIS FILE IS NO LONGER BEING USED AND IS HERE FOR REFERENCE UNTIL WE DELETE IT
 * /
...
//                {
//                    var userIdFilter = Builders<User>.Filter.Eq("_id", users.userID);
...
//                                    */
//                                    //if(users != null)
//                                    //foreach (TimeCard timecards in TimeCard) // Loop through timecard list, get card details, fill card list item
//                                    //{
...
//        public static void GetUserProjectsList(int userID)
//        {
